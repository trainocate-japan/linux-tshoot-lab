...
#### CPU負荷を異常に上昇
- stressかyesコマンドを利用します
- 作業に影響が出るほど負荷をかけられないので、障害発生前にNetdataで取得した情報と比較して気づけるようにします
...
## その他
- 受講者ホストはリブートすると障害発生前の状態に戻ります。なのでrebootとshutdown -r nowはできないようにsudoersで制限してます
